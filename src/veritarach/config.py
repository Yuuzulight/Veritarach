...
class Settings(BaseSettings):
    ...
    openai_model: str = "gpt-4o"  # verify this is still current at implementation time
    gemini_model: str = "gemini-2.0-flash"  # verify free-tier eligibility at implementation time
